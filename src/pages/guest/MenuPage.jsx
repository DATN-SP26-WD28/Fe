  ...
  return (
    <>
      ...
      <div className="max-w-[1280px] mx-auto w-full px-3 py-3 md:px-6 md:py-6 lg:px-8 lg:py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:gap-4 lg:gap-5 divide-y divide-gray-200 md:divide-y-0">
          {MOCK_DISHES.map((dish) => (
            <div key={`${dish.id}-${dish.name}`} className="py-3 md:px-3">
              <FoodCard
                image={dish.image}
                name={dish.name}
