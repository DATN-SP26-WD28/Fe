...
const NavItem = ({ icon, label, path, onClick, navigate, location }) => {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 h-16 bg-white border-t flex items-center justify-around z-50 pb-safe shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
        ...
        <NavItem icon={<FileTextOutlined />} label="Đã gọi" path="/orders" onClick={() => setShowOrders(true)} navigate={navigate} location={location} />
